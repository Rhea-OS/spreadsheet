...
export default function Integration(props: { plugin: SpreadsheetPlugin }) {
    ...
    return <section className={"integrations settings-group"}>
        <div className="description iintegration-desc">
            <h1>{"Data"}</h1>
            <p>{"If you need custom functionality, you can define your own values here. "}</p>
        </div>
