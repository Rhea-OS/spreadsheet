...
export function Spreadsheet(props: { sheet: StateHolder, settings: Settings }) {
    ...
    const renderColumn = (col: ColumnHeader) => <div className={"column-title"}
    ...
    const renderRow = (row: number) => <div className={"row-title"}
        ...
        <div className={"spreadsheet"}
            ...
            <Table sheet={sheet}
                ...
                {mkTableCell(sheet, (cell, addr) => <div className={"table-cell-inner"}
                                                         onContextMenu={e => contextMenu(e, props.sheet)}
                                                         onMouseDown={e => {
...
export function contextMenu(e: React.MouseEvent<HTMLDivElement>, sheet: StateHolder) {
